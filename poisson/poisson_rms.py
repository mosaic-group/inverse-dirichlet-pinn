...
for epoch in range(n_epochs):
    ...
    if(epoch % 5000 == 0 ):
        torch.save(net, './models/poisson_rms_meth' + str(method) + '_scale' + str(scale) + '_5L' + '_N2500' + '_ep' + str(epoch)  + '_' + "tanh" + "_seed"+ str(seed) + '_eps1e5.pth')
        ...
        sio.savemat("./results/poisson_rms_param_track_N2500_scale{}_method{}_seed{}_eps1e5".format(scale, method, seed), mdict)
